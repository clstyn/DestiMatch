            ...
            <div className="bg-textwhite rounded-[20px] text-textblack justify-center px-9 py-6 mt-6 w-[552px]">
                <form action="" onSubmit={handleSubmit} className="">
                    ...
                    <div className="flex flex-col items-center mt-8">
                        <button className="rounded-[20px] bg-pink1 px-12 py-3 text-textwhite font-bold mx-auto">LOGIN</button>
                        <p className='mt-4'>Belum memiliki akun? <span className='text-[#bf002f]'><a href="">Daftar</a></span></p>
                    </div>
                </form>
            </div>
        </div>
